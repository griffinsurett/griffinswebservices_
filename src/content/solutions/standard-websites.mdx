  ...
  <ul slot="proof-points" class="space-y-3">
    <li class="flex items-start gap-3">
      ...
      <p class="text-sm text-muted">
        Custom design that reflects your brand and stands out from template sites.
      </p>
    </li>
    <li class="flex items-start gap-3">
      <span aria-hidden="true" class="text-accent mt-1">✓</span>
    ...
    <li class="flex items-start gap-3">
      <span aria-hidden="true" class="text-accent mt-1">✓</span>
      <p class="text-sm text-muted">
        SEO-optimized architecture so customers can find you on Google.
      </p>
    </li>
    <li class="flex items-start gap-3">
      <span aria-hidden="true" class="text-accent mt-1">✓</span>
      <p class="text-sm text-muted">
        Contact forms, analytics, and training so you can manage it yourself.
      </p>
    </li>
  </ul>
