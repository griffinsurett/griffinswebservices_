...
export default function AccentPicker() {
  ...
  return (
    <div ref={containerRef} className="relative inline-flex">
      ...
      {open && (
        <div
          className="absolute top-full mt-2 right-0 sm:left-0 sm:right-auto faded-bg rounded-xl p-1 lg:p-3 flex space-x-3 overflow-x-auto hide-scrollbar shadow-lg z-50 w-max max-w-[calc(100vw-2.5rem)] sm:max-w-none"
        >
          {accents.map((color) => (
            <SquareCheckbox
              key={color}
