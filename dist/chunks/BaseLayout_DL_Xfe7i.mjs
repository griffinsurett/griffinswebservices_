import { c as createComponent, r as renderComponent, F as Fragment, a as renderTemplate, e as addAttribute, s as spreadAttributes, u as unescapeHTML, b as createAstro, k as renderScript, m as maybeRenderHead, g as renderSlot, _ as __astro_tag_component__, d as createVNode, A as AstroError, l as NoImageMetadata, n as FileGlobNotSupported, o as FileParserNotFound, L as LiveContentConfigError, j as AstroUserError, U as UnknownContentCollectionError, R as RenderUndefinedEntryError, p as renderUniqueStylesheet, q as renderScriptElement, t as createHeadAndContent, E as ExpectedImage, v as LocalImageUsedWrongly, w as MissingImageDimension, x as UnsupportedImageFormat, I as IncompatibleDescriptorOptions, y as UnsupportedImageConversion, z as toStyleString, B as FailedToFetchRemoteImageDimensions, C as ExpectedImageOptions, D as ExpectedNotESMImage, G as InvalidImageService, H as ImageMissingAlt, J as ExperimentalFontsNotEnabled, K as FontFamilyNotFound, O as defineScriptVars, P as renderHead } from './astro/server_BVIX8Iu0.mjs';
import 'piccolore';
/* empty css                          */
import 'clsx';
import { s as siteData } from './creative-studio-development-support_Cln8KS8O.mjs';
import { jsxs, jsx, Fragment as Fragment$1 } from 'react/jsx-runtime';
import { useRef, useCallback, useEffect, useState, useMemo, isValidElement, createElement, forwardRef, createContext, Children, useId, useLayoutEffect, useImperativeHandle, memo, useTransition, Suspense, lazy } from 'react';
...
import { L as LazyHamburgerMenu, u as useLazyLoad, a as LazyCookieConsent } from './lazy-utils_CggRUKqT.mjs';
/* empty css                                 */
/* empty css                                                                             */
/* empty css                                     */
/* empty css                                                                      */
...
function Heading({
  ...
  return /* @__PURE__ */ jsx(TagComponent, { className: `${finalClassName} capitalize`, ...props, children: hasSegmented ? /* @__PURE__ */ jsxs(Fragment$1, { children: [
  ...
  ] }) : isPropBased ? /* @__PURE__ */ jsxs(Fragment$1, { children: [
    before !== void 0 && /* @__PURE__ */ jsxs(Fragment$1, { children: [
      /* @__PURE__ */ jsx("span", { ...mergeProps(beforeId, beforeClass, beforeProps), children: before }),
      " "
    ] }),
    text !== void 0 && /* @__PURE__ */ jsxs(Fragment$1, { children: [
...
const $$file$q = "/Users/griffinsurett/coding/2025-Website-Projects/griffinswebservices/new/Griffins_Web_Services/src/components/ContentRenderer/variants/AccordionVariant.astro";
...
const $$CardRenderer = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${safeItems.length > 0 && renderTemplate`${maybeRenderHead()}<ul${addAttribute(`${columnClasses[columns]} list-none ${className}`.trim(), "class")}>${safeItems.map((item, index) => renderTemplate`<li class="h-full">${(() => {
    ...
    return renderTemplate`${renderComponent($$result, "FeatureCard", FeatureCard, { "client:idle": true, "data": item, "ringDuration": resolvedRingDuration, "className": resolvedClassName, ...restFeatureCardProps, "client:component-hydration": "idle", "client:component-path": "@/components/LoopComponents/FeatureCard", "client:component-export": "default" })}`;
  })()}</li>`)}</ul>`}`;
...
const $$file$p = "/Users/griffinsurett/coding/2025-Website-Projects/griffinswebservices/new/Griffins_Web_Services/src/components/ContentRenderer/variants/BenefitsInlineVariant.astro";
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_C4NRwbkF.mjs');
...
const __vite_import_meta_env__$1 = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "PUBLIC_SITE_DOMAIN": "https://griffinswebservices.com", "SITE": "https://https://griffinswebservices.com", "SSR": true};
...
function createGetCollection({
  ...
  return async function getCollection(collection, filter) {
    ...
    if (collection in contentCollectionToEntryMap) {
      ...
      const { default: imageAssetMap } = await import('./content-assets_BHklvbrY.mjs');
      const result = [];
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_DoqmGswt.mjs');
...
async function buildRelationshipGraph(options = {}) {
  ...
  const { extractRelationConfig, normalizeReference, isParentField } = await import('./schema_DHvshcyJ.mjs');
...
const $$CheckListItem = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$z, $$props, $$slots);
  Astro2.self = $$CheckListItem;
  const {
  ...
  return renderTemplate`${maybeRenderHead()}<div${addAttribute(`flex items-start gap-3 ${className}`, "class")}> <div${addAttribute(`w-5 h-5 rounded-full ${checkmarkBgColor} flex items-center justify-center flex-shrink-0 mt-0.5`, "class")}> <svg${addAttribute(`w-3 h-3 ${checkmarkColor}`, "class")} fill="currentColor" viewBox="0 0 20 20"> <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path> </svg> </div> <span${addAttribute(textClassName, "class")}> ${renderSlot($$result, $$slots["default"])} </span> </div>`;
}, "/Users/griffinsurett/coding/2025-Website-Projects/griffinswebservices/new/Griffins_Web_Services/src/components/LoopComponents/CheckListItem.astro", void 0);
...
const $$ChecklistVariant = createComponent(($$result, $$props, $$slots) => {
  ...
  const {
    ...
    ctaText,
    heading: headingValue,
    checkmarkColor = "text-accent",
    checkmarkBgColor = "bg-accent/15"
  } = Astro2.props;
  const safeItems = toArray(items);
  const columnClasses = {
    1: "grid-cols-1",
  ...
  const showHeader = Boolean(title || headingPayload || description);
  const showCTA = showButtonSection && shouldShowCollectionCTA(collectionUrl, safeItems.length) && (ctaText || title || collectionTitle) && (ctaHref || collectionUrl);
  return renderTemplate`${maybeRenderHead()}<section${addAttribute(id, "id")}${addAttribute(`relative ${className}`.trim(), "class")}> <div class="inner-section"> ${showHeader && renderTemplate`${renderComponent($$result, "SectionHeader", $$SectionHeader, { "title": title, "heading": headingPayload, "description": description, "className": "text-section" })}`} ${safeItems.length > 0 && renderTemplate`<ul${addAttribute(`grid ${columnClasses[columns]} gap-4 mt-8 list-none`, "class")}> ${safeItems.map((item) => renderTemplate`<li> ${renderComponent($$result, "CheckListItem", $$CheckListItem, { "checkmarkColor": checkmarkColor, "checkmarkBgColor": checkmarkBgColor, "textClassName": "text-text leading-relaxed" }, { "default": ($$result2) => renderTemplate` <span class="font-medium text-heading">${item.title}</span> ${item.description && renderTemplate`<span class="block text-sm text-muted mt-1">${item.description}</span>`}` })} </li>`)} </ul>`} ${showCTA && renderTemplate`<div class="buttons-section-center"> ${renderComponent($$result, "Button", Button, { "client:visible": true, "href": ctaHref ?? collectionUrl, "rightIcon": "lu:arrow-right", "variant": "secondary", "client:component-hydration": "visible", "client:component-path": "@/components/Button/Button", "client:component-export": "default" }, { "default": ($$result2) => renderTemplate`${ctaText ?? `View All ${(title ?? collectionTitle ?? "").trim()}`}` })} </div>`} </div> </section>`;
...
const $$file$h = "/Users/griffinsurett/coding/2025-Website-Projects/griffinswebservices/new/Griffins_Web_Services/src/components/ContentRenderer/variants/GridVariant.astro";
...
const $$file$g = "/Users/griffinsurett/coding/2025-Website-Projects/griffinswebservices/new/Griffins_Web_Services/src/components/ContentRenderer/variants/IconListVariant.astro";
...
const $$file$f = "/Users/griffinsurett/coding/2025-Website-Projects/griffinswebservices/new/Griffins_Web_Services/src/components/ContentRenderer/variants/LinkTreeVariant.astro";
...
function ComputerScreen({
  ...
  const resolvedFetchPriority = wantsDesktopEager ? "high" : mediaEntry?.fetchPriority ?? "auto";
  const renderMedia = () => {
    if (deferImageRender) {
...
const $$PortfolioScreenVariant = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<section${addAttribute(id, "id")}${addAttribute(`relative overflow-hidden p-6 ${className}`.trim(), "class")}> <div class="relative w-full max-w-4xl mx-auto h-[420px] sm:h-[500px]">  ${renderTemplate`<div class="absolute inset-0 z-0"> ${renderComponent($$result, "PortfolioScreenShowcase", PortfolioScreenShowcase, { "client:visible": true, "items": portfolioItems, "mediaEntries": showcaseMedia, "className": "w-full mx-auto", "staticContainerId": "portfolio-static-first", "client:component-hydration": "visible", "client:component-path": "@/components/LoopTemplates/PortfolioScreenShowcase/PortfolioScreenShowcase", "client:component-export": "default" })} </div>`}  <div id="portfolio-static-first" class="absolute inset-0 z-10 overflow-hidden rounded-lg transition-opacity duration-500"> <div class="relative h-full w-full"> <div class="relative h-full bg-bg3"> <div class="flex flex-col gap-3 border-b border-white/10 px-4 py-3 text-white/70 sm:flex-row sm:items-center sm:justify-between"> <div class="flex items-center gap-3 text-xs uppercase tracking-[0.35em] text-white/50"> <span class="flex items-center gap-1.5"> <span class="h-3 w-3 rounded-full bg-gray-800"></span> <span class="h-3 w-3 rounded-full bg-gray-800"></span> <span class="h-3 w-3 rounded-full bg-gray-800"></span> </span> </div> </div> <figure class="relative h-full overflow-y-auto overscroll-contain bg-black/40">  ${firstPreview?.src ? renderTemplate`<picture> ${firstPreview.sources?.map((source) => renderTemplate`<source${addAttribute(source.srcSet, "srcset")}${addAttribute(source.sizes, "sizes")}${addAttribute(source.type, "type")}>`)} <img${addAttribute(firstPreview.src, "src")}${addAttribute(firstPreview.srcSet, "srcset")}${addAttribute(firstPreview.sizes, "sizes")}${addAttribute(firstPreview.alt || firstItem?.title || "Project preview", "alt")}${addAttribute(firstPreview.width, "width")}${addAttribute(firstPreview.height, "height")} loading="eager" decoding="async" fetchpriority="high" draggable="false" class="block h-auto min-h-full w-full select-none object-cover object-top"> </picture>` : null} </figure> </div> </div> </div> </div> </section>`;
...
const $$PortfolioVariant = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<section${addAttribute(id, "id")}${addAttribute(`outer-section bg-bg relative overflow-hidden ${className}`.trim(), "class")}> <div class="section-dim-border"></div> <div class=""> ${showHeader && renderTemplate`${renderComponent($$result, "SectionHeader", $$SectionHeader, { "title": sectionTitle, "heading": headingPayload, "description": description, "className": "text-center", "headingClassName": "h2 mb-6 heading-padding", "descriptionClassName": "large-text max-w-2xl mx-auto" })}`} ${portfolioItems.length > 0 && renderTemplate`${renderComponent($$result, "PortfolioCarousel", PortfolioCarousel, { "client:visible": true, "items": portfolioItems, "autoplay": autoplay, "autoAdvanceDelay": autoAdvanceDelay, "className": showHeader ? "mt-12" : "", "client:component-hydration": "visible", "client:component-path": "@/components/LoopTemplates/PortfolioCarousel", "client:component-export": "default" }, { "default": ($$result2) => renderTemplate`${carouselMedia.map(
    (media) => media ? renderTemplate`${renderComponent($$result2, "Image", $$Image, { "data-portfolio-media": true, "src": media.metadata, "alt": media.alt, "loading": "lazy", "widths": [480, 640, 860, 1024, 1280, 1600], "sizes": "(max-width: 640px) 90vw, (max-width: 1024px) 70vw, 860px", "class": "block w-full h-auto min-h-full select-none object-cover object-top", "draggable": "false" })}` : renderTemplate`<span data-portfolio-placeholder class="hidden"></span>`
...
const $$file$5 = "/Users/griffinsurett/coding/2025-Website-Projects/griffinswebservices/new/Griffins_Web_Services/src/components/ContentRenderer/variants/StatsVariant.astro";
...
const $$file$4 = "/Users/griffinsurett/coding/2025-Website-Projects/griffinswebservices/new/Griffins_Web_Services/src/components/ContentRenderer/variants/TechnologiesVariant.astro";
...
const $$file$3 = "/Users/griffinsurett/coding/2025-Website-Projects/griffinswebservices/new/Griffins_Web_Services/src/components/ContentRenderer/variants/TestimonialCarouselVariant.astro";
...
const $$TwoColumnImageVariant = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<section${addAttribute(id, "id")}${addAttribute(`outer-section ${bgClass} relative ${className}`.trim(), "class")}> ${borderClass && renderTemplate`<div${addAttribute(borderClass, "class")}></div>`} <div class="inner-section"> <div class="flex flex-col lg:flex-row gap-12 lg:gap-16 items-start">  <div${addAttribute(`lg:flex-1 w-full sticky-section ${imageOrderClass} ${imageClassName}`.trim(), "class")}> <div${addAttribute(`aspect-[4/3] rounded-3xl bg-muted/10 border border-muted/20 flex items-center justify-center ${stickyImage ? "sticky-section" : ""}`.trim(), "class")}> ${imageSrc ? renderTemplate`<img${addAttribute(imageSrc, "src")}${addAttribute(imageAlt, "alt")} class="w-full h-full object-cover rounded-3xl">` : renderTemplate`<div class="text-center p-8"> <div class="w-16 h-16 mx-auto mb-4 rounded-full bg-accent/10 flex items-center justify-center"> <span class="text-accent text-2xl">${imagePlaceholder}</span> </div> <p class="text-muted text-sm">${imageAlt}</p> </div>`} </div> </div>  <div${addAttribute(`lg:flex-1 space-y-8 ${contentOrderClass} ${contentClassName}`.trim(), "class")}> ${showHeader && renderTemplate`${renderComponent($$result, "SectionHeader", $$SectionHeader, { "title": title, "heading": heading, "description": description, "className": "text-left" })}`} ${hasSlotContent && renderTemplate`<div class="slot-content"> ${renderSlot($$result, $$slots["default"])} </div>`} </div> </div> </div> </section>`;
...
const $$file$1 = "/Users/griffinsurett/coding/2025-Website-Projects/griffinswebservices/new/Griffins_Web_Services/src/components/ContentRenderer/variants/TwoColumnImageVariant.astro";
...
function LanguageDropdown() {
  ...
  const handleOpenConsentModal = () => {
    if (!ConsentModal) {
      import('./CookiePreferencesModal_BN3mRiaV.mjs').then((m) => {
  ...
  return /* @__PURE__ */ jsxs("div", { ref: containerRef, className: "relative contents", children: [
    ...
    open && /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          !hasFunctionalConsent && /* @__PURE__ */ jsxs(
            "button",
            {
              type: "button",
...
const CookiePreferencesModal = lazy(() => import('./CookiePreferencesModal_BN3mRiaV.mjs'));
...
function AccessibilityButton() {
  const { Component: Modal, isOpen, close } = useLazyLoad(
    () => import('./AccessibilityModal_CrXVdVkd.mjs'),
...
export { $$BaseLayout as $, Accordion as A, Button as B, Checkbox as C, related as D, capitalizeWords as E, FormWrapper as F, getItemProperty as G, __vite_glob_0_0 as H, Icon as I, useLocalStorageState as J, AnimatedBorder as K, supportedLanguages as L, getLanguageByCode as M, __vite_glob_0_0$1 as N, __vite_glob_0_1 as O, __vite_glob_0_2$1 as P, __vite_glob_0_3$1 as Q, __vite_glob_0_4$1 as R, __vite_glob_0_5$1 as S, Textarea as T, __vite_glob_0_6$1 as U, __vite_glob_0_7$1 as V, __vite_glob_0_8$1 as W, __vite_glob_0_9$1 as X, __vite_glob_0_10$1 as Y, __vite_glob_0_11$1 as Z, __ASTRO_IMAGE_IMPORT_18zSQ8 as _, $$ContentRenderer as a, __vite_glob_0_12$1 as a0, __vite_glob_0_13$1 as a1, __vite_glob_0_14$1 as a2, __vite_glob_0_15$1 as a3, __vite_glob_0_16$1 as a4, formatPhoneNumber as b, createSvgComponent as c, shouldProcessCollection as d, getCollection as e, find as f, getCollectionMeta as g, getItemKey as h, shouldItemHavePage as i, shouldItemUseRootPath as j, $$SectionHeader as k, baseService as l, IconListItem as m, sortByOrder as n, __ASTRO_IMAGE_IMPORT_s0yHl as o, parseQuality as p, query as q, roots as r, sortBy as s, $$TwoColumnImageVariant as t, shouldCollectionHavePage as u, collections as v, isCollectionReference as w, getImageSrc as x, getAuthorName as y, Input as z };
