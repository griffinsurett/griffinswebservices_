async function getMod$f() {
						return import('./certified-bag-chasers-light_B8CQtJJw.mjs');
					}
...
async function getMod$e() {
						return import('./can-you-collaborate-with-our-team_9JmnQ6fp.mjs');
					}
...
async function getMod$d() {
						return import('./can-you-redesign-my-current-site_BsHhDyE3.mjs');
					}
...
async function getMod$c() {
						return import('./accessibility-compliance_IRebCiC4.mjs');
					}
...
async function getMod$b() {
						return import('./e-commerce-development_DN1AUdLv.mjs');
					}
...
async function getMod$a() {
						return import('./managed-website-hosting_C1W7_P5e.mjs');
					}
...
async function getMod$9() {
						return import('./will-my-website-be-mobile-friendly_im6JWU6H.mjs');
					}
...
async function getMod$8() {
						return import('./performance-optimization_BgR9RxSd.mjs');
					}
...
async function getMod$7() {
						return import('./marketing-professionals_SYgO4b5H.mjs');
					}
...
async function getMod$6() {
						return import('./product-based-businesses_CR9kyIb1.mjs');
					}
...
async function getMod$5() {
						return import('./real-estate-professionals_CcZMzsfj.mjs');
					}
...
async function getMod$4() {
						return import('./restaurants-food-service_KpFxXS6E.mjs');
					}
...
async function getMod$3() {
						return import('./seo-agency-partnerships_QjqZbOuO.mjs');
					}
...
async function getMod$2() {
						return import('./subscription-box-companies_DO0qbRP8.mjs');
					}
...
async function getMod$1() {
						return import('./white-label-development_BefYhWCm.mjs');
					}
...
async function getMod() {
						return import('./window-door-installation_BhAirpTD.mjs');
					}
...
export { canYouCollaborateWithOurTeam as a, canYouRedesignMyCurrentSite as b, certifiedBagChasersLight as c, accessibilityCompliance as d, eCommerceDevelopment as e, marketingProfessionals as f, productBasedBusinesses as g, restaurantsFoodService as h, subscriptionBoxCompanies as i, whiteLabelDevelopment as j, windowDoorInstallation as k, managedWebsiteHosting as m, performanceOptimization as p, realEstateProfessionals as r, seoAgencyPartnerships as s, willMyWebsiteBeMobileFriendly as w };
