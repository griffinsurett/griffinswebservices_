import { v as collections, w as isCollectionReference, f as find, x as getImageSrc, $ as $$BaseLayout, y as getAuthorName, a as $$ContentRenderer, q as query, F as FormWrapper, z as Input, T as Textarea, C as Checkbox, B as Button, k as $$SectionHeader, n as sortByOrder, D as related, E as capitalizeWords, G as getItemProperty, H as __vite_glob_0_0 } from './BaseLayout_DL_Xfe7i.mjs';
import { b as createAstro, c as createComponent, r as renderComponent, a as renderTemplate, m as maybeRenderHead, e as addAttribute, g as renderSlot } from './astro/server_BVIX8Iu0.mjs';
import 'piccolore';
import 'clsx';
import './background_By5FNFZQ.mjs';
/* empty css                         */
import { s as siteData } from './creative-studio-development-support_Cln8KS8O.mjs';
import { $ as $$CTASection } from './CTASection_DzgCI2Qi.mjs';
...
const $$ServicesLayout = createComponent(($$result, $$props, $$slots) => {
  ...
  }, "description": "Every project is custom-crafted to help businesses stand out and convert visitors into customers. Yours could be next.", "ctaHref": "#services-quote-hero", "ctaText": "Get Your Free Quote" })} </div> ${benefits.length > 0 && renderTemplate`${renderComponent($$result2, "ContentRenderer", $$ContentRenderer, { "items": benefits, "variant": "CardVariant", "title": "Benefits", "heading": {
    before: "Why choose",
    text: title,
