...
import { k as $$SectionHeader, B as Button, a as $$ContentRenderer, q as query, t as $$TwoColumnImageVariant, n as sortByOrder } from './BaseLayout_DL_Xfe7i.mjs';
import './CTASection_DzgCI2Qi.mjs';
import 'clsx';
...
function _createMdxContent(props) {
  ...
  return createVNode(Fragment, {
    children: ["\n", createVNode("section", {
    ...
    }), "\n", "\n", createVNode($$TwoColumnImageVariant, {
      id: "the-opportunity",
      ...
      children: createVNode("div", {
        class: "space-y-4 text-lg text-muted leading-relaxed",
        children: [createVNode("p", {
          children: createVNode(_components.p, {
            children: "You didn’t start your business to become a web designer. You have customers to serve, a team to lead, a company to grow."
          })
        }), createVNode("p", {
          children: createVNode(_components.p, {
            children: ["But here’s the truth: most of your competitors have terrible websites—or none at all. That’s not a problem. ", createVNode("strong", {
              class: "text-heading",
              children: "That’s an opportunity."
            })]
          })
        }), createVNode("p", {
          children: createVNode(_components.p, {
            children: "A professional website instantly positions you as the credible choice. The one who shows up on Google. The one who looks established. The one customers trust before they ever call."
          })
        }), createVNode("p", {
          class: "text-heading font-medium text-xl",
          children: createVNode(_components.p, {
            children: "We build that advantage for you."
          })
        })]
      })
    }), "\n", "\n", createVNode($$TwoColumnImageVariant, {
